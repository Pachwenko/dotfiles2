...
return {
	...
	config = function()
		require("persisted").setup({
			...
			save_dir = vim.fn.expand(vim.fn.stdpath("data") .. "/neovim_persisted_sessions/"), -- Directory where session files are saved
			...
			allowed_dirs = { "~/Projects" }, -- Table of dirs that the plugin will start and autoload from
