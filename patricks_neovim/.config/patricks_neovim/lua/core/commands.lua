...
-- 1.	Runs a ripgrep search in the projects_dir for all files and folders, filtering out hidden files and node_modules, then piping to fzf to format in a nice way.
-- 2.	Uses vim.fn.systemlist() to capture the output of fzf, which returns the selected directory.
